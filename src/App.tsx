...
function App() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#070A12] text-[#F1F5F9] font-sans antialiased flex flex-col items-center">
      {/* 1. Navbar */}
      <Navbar />

      {/* 2. Hero Section (Scroll Morphing) */}
      <section id="hero" className="w-full relative">
        <IntroAnimation />
      </section>

      {/* 3. Malla Parallax (Aceternity Parallax Wall) */}
      <section id="products-parallax" className="w-full relative">
        <HeroParallax />
      </section>

      {/* 4. El Problema (Pain Section) */}
      <section className="w-full max-w-7xl px-6 md:px-12 py-24 text-left border-t border-gray-900/60">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#111827]/60 border border-gray-800/40 rounded-xl p-8 backdrop-blur-sm transition-all duration-300 hover:border-gray-700/60 hover:shadow-lg hover:shadow-[#2563EB]/5">
      ...
      {/* 5. La Solución (Reveal Section / Pillars) */}
      <section className="w-full bg-[#0D1117] py-24 border-y border-gray-900/60 flex justify-center">
      ...
      <section id="products" className="w-full max-w-7xl px-6 md:px-12 py-24 text-left">
        <div className="max-w-3xl mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Axiom Card */}
          <div className="bg-[#111827]/80 border-t-4 border-t-[#2563EB] border border-gray-800/50 rounded-xl p-8 md:p-10 flex flex-col justify-between hover:shadow-2xl hover:shadow-[#2563EB]/5 transition-all">
            <div>
          ...
          {/* Axiom Tag */}
          <div className="bg-[#111827]/80 border-t-4 border-t-[#7C3AED] border border-gray-800/50 rounded-xl p-8 md:p-10 flex flex-col justify-between hover:shadow-2xl hover:shadow-[#7C3AED]/5 transition-all">
            <div>
              <div className="flex justify-between items-center mb-6">
      ...
      {/* 7. Cómo Funciona */}
      <section id="how-it-works" className="w-full bg-[#0D1117]/80 py-24 border-y border-gray-900/60 flex justify-center">
        <div className="w-full max-w-7xl px-6 md:px-12 text-left">
          <div className="max-w-3xl mb-16">
      ...
      <section id="segments" className="w-full max-w-7xl px-6 md:px-12 py-24 text-left">
        <div className="max-w-3xl mb-16">
        ...
        {/* Segments Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[#111827]/60 border border-gray-800/40 rounded-xl p-8 text-left hover:border-gray-700/60 transition-all flex flex-col justify-between">
            <div>
            ...
            <div className="mt-8 pt-4 border-t border-gray-800/30 text-xs text-[#94A3B8] font-medium italic">
      ...
      <section id="why-us" className="w-full bg-[#0D1117]/80 py-24 border-y border-gray-900/60 flex justify-center">
        <div className="w-full max-w-7xl px-6 md:px-12 text-left">
          <div className="max-w-3xl mb-16">
          ...
          {/* 6 Grid Benefits */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#111827]/30 border border-gray-800/40 p-6 rounded-xl">
      ...
      <section className="w-full max-w-7xl px-6 md:px-12 py-24 text-center">
      ...
      <section className="w-full max-w-5xl px-6 py-12 text-left">
        ...
        <div className="w-full overflow-x-auto rounded-xl border border-gray-800/40 bg-[#111827]/20 backdrop-blur-sm">
          <table className="w-full text-left border-collapse min-w-[600px]">
            <thead>
              <tr className="border-b border-gray-800/60 bg-gray-900/40 text-xs font-bold text-[#F1F5F9] uppercase">
            ...
            <tbody className="text-sm">
              {compareFeatures.map((row, idx) => (
                <tr key={idx} className="border-b border-gray-900/60 hover:bg-gray-900/20">
      ...
      {/* 12. FAQ Accordion */}
      <section id="faq" className="w-full max-w-4xl px-6 md:px-12 py-24 text-left border-t border-gray-900/60">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                key={index}
                className="border border-gray-800/40 bg-[#111827]/40 backdrop-blur-sm rounded-xl overflow-hidden transition-all duration-300"
              >
                <button
                ...
                <div
                  className={`transition-all duration-300 overflow-hidden ${
                    isOpen ? "max-h-[300px] border-t border-gray-900/50 py-5 px-6" : "max-h-0"
                  }`}
                >
      ...
      {/* 13. CTA Final */}
      <section id="cta" className="w-full max-w-5xl px-6 py-20 text-center">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#2563EB] to-[#7C3AED] px-8 py-16 md:py-24 shadow-2xl flex flex-col items-center justify-center">
          {/* Subtle overlay */}
          ...
          <div className="relative z-10 max-w-2xl flex flex-col items-center gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8 w-full justify-center">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-8 py-4 bg-[#070A12] text-[#F1F5F9] text-sm font-bold rounded-lg border border-gray-800 hover:border-gray-600 transition shadow-lg flex items-center justify-center gap-2"
              >
